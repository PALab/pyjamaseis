...
There are several modules not named here that need to also be installed, to know what these are first install all the above modules, then run PyjAmaseis and the required modules will be notified to you via the following error - “ImportError: No module named …”. Most of these remaining modules can be found here - http://www.lfd.uci.edu/~gohlke/pythonlibs/ and https://wiki.python.org/moin/UsefulModules
